...
TEST(TokenizerTest, validString_1) {
    ...
    EXPECT_EQ("mkdir hi", tokens.at(4)->toString());
}
...
TEST(TokenizerTest, validString_2) {
    ...
    EXPECT_EQ("echo testing", tokens.at(2)->toString());
}
...
TEST(TokenizerTest, validString_3) {
    ...
    EXPECT_EQ("echo hello", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, validString_4) {
    ...
    EXPECT_EQ("exit ", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, validString_5) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(1, tokens.size());
    EXPECT_EQ("ls ", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, validString_6) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(1, tokens.size());
    EXPECT_EQ("echo ", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, validString_7) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(1, tokens.size());
    EXPECT_EQ("pwd ", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, validString_8) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(3, tokens.size());
    EXPECT_EQ("ls -a", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, validString_9) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(3, tokens.size());
    EXPECT_EQ("&&", tokens.at(1)->toString());
}
...
TEST(TokenizerTest, validString_10) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(3, tokens.size());
    EXPECT_EQ("echo heya", tokens.at(2)->toString());
}
...
TEST(TokenizerTest, validString_11) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(1, tokens.size());
    EXPECT_EQ("echo hello && goodbye", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, validString_12) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(3, tokens.size());
    EXPECT_EQ("echo black# || blue", tokens.at(2)->toString());
}
...
TEST(TokenizerTest, validString_13) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(3, tokens.size());
    EXPECT_EQ("ls ", tokens.at(2)->toString());
}
...
TEST(TokenizerTest, validString_14) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(1, tokens.size());
    EXPECT_EQ("echo testing #123", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, validString_15) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(5, tokens.size());
    EXPECT_EQ("mkdir folder", tokens.at(4)->toString());
}
...
TEST(TokenizerTest, validString_16) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(3, tokens.size());
    EXPECT_EQ("echo hi", tokens.at(2)->toString());
}
...
TEST(TokenizerTest, validString_17) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(3, tokens.size());
    EXPECT_EQ("pwd ", tokens.at(2)->toString());
}
...
TEST(TokenizerTest, validString_18) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(1, tokens.size());
    EXPECT_EQ("cat -n example.txt", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, validString_20) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(1, tokens.size());
    EXPECT_EQ("git status", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, invalidString_1) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(1, tokens.size());
    EXPECT_EQ("ls echo mkdir exit pwd", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, invalidString_2) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(1, tokens.size());
    EXPECT_EQ("||", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, invalidString_5) {
    ...
    EXPECT_EQ("||", tokens.at(0)->toString());
    EXPECT_EQ(";", tokens.at(2)->toString());
}
...
TEST(TokenizerTest, invalidString_6) {
    ...
    EXPECT_EQ("&&", tokens.at(0)->toString());
    EXPECT_EQ("foijfoew eeeee dd", tokens.at(1)->toString());
}
...
TEST(TokenizerTest, invalidString_7) {
    ...
    EXPECT_EQ(";", tokens.at(3)->toString());
...
TEST(TokenizerTest, invalidString_8) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(1, tokens.size());
    EXPECT_EQ("mkdir echo", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, invalidString_13) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(1, tokens.size());
    EXPECT_EQ("e ", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, Parentheses1) {
    ...
    EXPECT_EQ("(", tokens.at(2)->toString());
    EXPECT_EQ("echo C", tokens.at(5)->toString());
}
...
TEST(TokenizerTest, Parentheses2) {
    ...
    EXPECT_EQ("(", tokens.at(0)->toString());
    EXPECT_EQ("(", tokens.at(1)->toString());
    EXPECT_EQ("echo D", tokens.at(5)->toString());
...
TEST(TokenizerTest, Parentheses3) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(3, tokens.size());
    EXPECT_EQ("echo test", tokens.at(1)->toString());
    EXPECT_EQ("(", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, Parentheses5) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(2, tokens.size());
    EXPECT_EQ("echo test", tokens.at(0)->toString());
    EXPECT_EQ(")", tokens.at(1)->toString());
}
...
TEST(TokenizerTest, Parentheses6) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(5, tokens.size());
    EXPECT_EQ("echo test", tokens.at(3)->toString());
    EXPECT_EQ("(", tokens.at(2)->toString());
}
...
TEST(TokenizerTest, Parentheses7) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(7, tokens.size());
    EXPECT_EQ("echo one", tokens.at(1)->toString());
    EXPECT_EQ("&&", tokens.at(2)->toString());
}
...
TEST(TokenizerTest, Parentheses13) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(1, tokens.size());
    EXPECT_EQ("echo (hello world)", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, Parentheses14) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(7, tokens.size());
    EXPECT_EQ("echo testing #thi(s is a comment()", tokens.at(1)->toString());
    EXPECT_EQ(")", tokens.at(4)->toString());
}
...
TEST(TokenizerTest, usingTestCommand1) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(3, tokens.size());
    EXPECT_EQ("test -e file.cpp", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, usingTestCommand2) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(3, tokens.size());
    EXPECT_EQ("test -f file.cpp", tokens.at(0)->toString());
    EXPECT_EQ("&&", tokens.at(1)->toString());
    EXPECT_EQ("echo one", tokens.at(2)->toString());
}
...
TEST(TokenizerTest, usingTestCommand3) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(1, tokens.size());
    EXPECT_EQ("echo I am not a test command but just a comment [-e somefile.cpp]", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, usingTestCommand4) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(3, tokens.size());
    EXPECT_EQ("test -e file.h", tokens.at(0)->toString());
    EXPECT_EQ("test file.cpp", tokens.at(2)->toString());
}
...
TEST(TokenizerTest, usingTestCommand5) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(3, tokens.size());
    EXPECT_EQ("echo echo:) :) [-e file.h]", tokens.at(0)->toString());
}
...
TEST(TokenizerTest, usingIOToken1) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(3, tokens.size());
    EXPECT_EQ("ls -la", tokens.at(0)->toString());
    EXPECT_EQ(">", tokens.at(1)->toString());
    EXPECT_EQ("output.txt ", tokens.at(2)->toString());
}
...
TEST(TokenizerTest, usingIOToken2) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(3, tokens.size());
    EXPECT_EQ("echo david phung", tokens.at(0)->toString());
    EXPECT_EQ(">", tokens.at(1)->toString());
    EXPECT_EQ("output.txt ", tokens.at(2)->toString());
}
...
TEST(TokenizerTest, usingIOToken3) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(3, tokens.size());
    EXPECT_EQ("echo ls > file.txt", tokens.at(0)->toString());
    EXPECT_EQ(">", tokens.at(1)->toString());
    EXPECT_EQ("output.txt ", tokens.at(2)->toString());
}
...
TEST(TokenizerTest, usingIOToken6) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ(13, tokens.size());
    EXPECT_EQ("<", tokens.at(5)->toString());
    EXPECT_EQ(">", tokens.back()->toString());
}
...
TEST(TokenizerTest, usingIOToken7) {
    ...
    EXPECT_EQ(">", tokens.at(2)->toString());
    EXPECT_EQ("echo sup", tokens.at(11)->toString());
}
...
TEST(TokenizerTest, usingIOToken8) {
    ...
    std::vector<Token*> tokens = Tokenizer::makeTokens(input);
    EXPECT_EQ("|", tokens.at(3)->toString());
    EXPECT_EQ("tr A-Z a-z", tokens.at(4)->toString());
    EXPECT_EQ("tee newOutputFile1", tokens.at(6)->toString());
